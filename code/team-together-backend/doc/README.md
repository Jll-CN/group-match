...
> 作者：[Jiale](https://github.com/liyupi)
...
主页、 找伙伴、 组队功能、 创建队伍、 个人信息及修改

项目基本覆盖了企业开发中常见的需求以及对应的解决方案，比如登录注册、批量数据导入、信息检索展示、定时任务、资源抢占等。并且涵盖了分布式、并发编程、锁、事务、缓存、性能优化、幂等性、数据一致性、大数据、算法等后端程序员必须了解的知识与实践。

## 基本条件
以下两个条件满足一个即可：
1. 基本的前端（例如，HTML+CSS+JS 三件套）
2. 后端开发技术（例如，Java Web）
